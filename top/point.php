    ...
    <div class="main">
        ...
        <table>
            ...
            <?php
                    ...
                    $result = sqlCommand("dptadven_playerpoints","select DISTINCT ROW_NUMBER() OVER(ORDER BY points DESC) AS ranking, playerpoints_points.points, playerpoints_username_cache.username name from playerpoints_points join playerpoints_username_cache on playerpoints_username_cache.uuid = playerpoints_points.uuid order by points desc limit 50")->fetchAll();
                ?>
            ...
            <tr>
                ...
                <td>
                    <?php
                            $output = sqlCommand("dptadven_playerpoints","SELECT DISTINCT points FROM playerpoints_points ORDER BY points DESC LIMIT 50")->fetchAll();
                            $listMoney = [];
